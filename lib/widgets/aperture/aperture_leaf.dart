...
import 'package:yolo/widgets/aperture/aperture_leaf_painter.dart';
...
class ApertureLeaf extends StatefulWidget {
  ...
  const ApertureLeaf(
      {super.key, required this.borderWidth,
...
class _ApertureLeafState extends State<ApertureLeaf>
  ...
  void initState() {
    ...
    curvedAnimation = (widget.curvedAnimation ?? CurvedAnimation(
