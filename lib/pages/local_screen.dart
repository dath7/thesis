...
import 'package:yolo/view_models/local_view_model.dart';
...
class _LocalScreenState extends BaseStateful<LocalScreen, LocalViewModel> {
  ...
  selectImage() async {
    ...
    viewModel.updateImageSelected(File(imageFile.path));


    FileImage(viewModel.state.imageSelected!)
    ...
    return AppBar(
      ...
      actions: [
        IconButton(
            ...
            icon: const Icon(AppIcons.linkOption, semanticLabel: 'Repo'))
      ],
