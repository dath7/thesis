...
import 'package:yolo/widgets/aperture/aperture_widget.dart';
import 'package:yolo/widgets/confidence_widget.dart';
...
class _HomeScreenState extends BaseStateful<HomeScreen, HomeViewModel>
  ...
  Future<bool> renderedAndSaveImage(Uint8List draw, XFile camera) async {
    ...
    final canvas = Canvas(
        ...
        Rect.fromPoints(
            ...
            Offset(cameraImage.width.toDouble(),
  ...
  Widget buildBodyWidget(BuildContext context) {
    ...
    final Size previewSize =
        isInitialized ? _cameraController.value.previewSize! : const Size(100, 100);
